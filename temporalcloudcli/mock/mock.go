...
// NewMockApplyPrompter creates a new instance of MockApplyPrompter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockApplyPrompter(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockApplyPrompter {
	mock := &MockApplyPrompter{}
	mock.Mock.Test(t)
...
// MockApplyPrompter is an autogenerated mock type for the ApplyPrompter type
type MockApplyPrompter struct {
	mock.Mock
}

type MockApplyPrompter_Expecter struct {
	mock *mock.Mock
}

func (_m *MockApplyPrompter) EXPECT() *MockApplyPrompter_Expecter {
	return &MockApplyPrompter_Expecter{mock: &_m.Mock}
}

// PromptApply provides a mock function for the type MockApplyPrompter
func (_mock *MockApplyPrompter) PromptApply(old proto.Message, new proto.Message, verbose bool) error {
...
// MockApplyPrompter_PromptApply_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PromptApply'
type MockApplyPrompter_PromptApply_Call struct {
	*mock.Call
}
...
//   - new proto.Message
//   - verbose bool
func (_e *MockApplyPrompter_Expecter) PromptApply(old interface{}, new interface{}, verbose interface{}) *MockApplyPrompter_PromptApply_Call {
	return &MockApplyPrompter_PromptApply_Call{Call: _e.mock.On("PromptApply", old, new, verbose)}
}

func (_c *MockApplyPrompter_PromptApply_Call) Run(run func(old proto.Message, new proto.Message, verbose bool)) *MockApplyPrompter_PromptApply_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockApplyPrompter_PromptApply_Call) Return(err error) *MockApplyPrompter_PromptApply_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockApplyPrompter_PromptApply_Call) RunAndReturn(run func(old proto.Message, new proto.Message, verbose bool) error) *MockApplyPrompter_PromptApply_Call {
	_c.Call.Return(run)
	return _c
}
