...
func NewCloudNamespaceSearchAttributeCommand(cctx *CommandContext, parent *CloudNamespaceCommand) *CloudNamespaceSearchAttributeCommand {
	...
	s.Command.AddCommand(&NewCloudNamespaceSearchAttributeDeleteCommand(cctx, &s).Command)
...
func NewCloudNamespaceSearchAttributeCreateCommand(cctx *CommandContext, parent *CloudNamespaceSearchAttributeCommand) *CloudNamespaceSearchAttributeCreateCommand {
	...
	s.Command.Args = cobra.NoArgs
	s.Command.Flags().StringVar(&s.Name, "name", "", "The name of the search attribute to create.")
	s.Command.Flags().StringVar(&s.Type, "type", "", "The type of the search attribute. Valid values: Text, Keyword, Int, Double, Bool, Datetime, KeywordList.")
	s.ClientOptions.BuildFlags(s.Command.Flags())
	s.NamespaceOptions.BuildFlags(s.Command.Flags())
	s.ResourceModifyOptions.BuildFlags(s.Command.Flags())
	s.Command.Run = func(c *cobra.Command, args []string) {
...
type CloudNamespaceSearchAttributeDeleteCommand struct {
	Parent  *CloudNamespaceSearchAttributeCommand
	Command cobra.Command
	ClientOptions
	NamespaceOptions
...
func NewCloudNamespaceSearchAttributeDeleteCommand(cctx *CommandContext, parent *CloudNamespaceSearchAttributeCommand) *CloudNamespaceSearchAttributeDeleteCommand {
	var s CloudNamespaceSearchAttributeDeleteCommand
	s.Parent = parent
	s.Command.DisableFlagsInUseLine = true
	s.Command.Use = "delete [flags]"
	s.Command.Short = "Delete a custom search attribute from a namespace"
	s.Command.Long = "Delete a custom search attribute from a Temporal Cloud namespace.\nNote: This removes the search attribute from the namespace configuration,\nbut historical data may still exist in the backend."
	s.Command.Args = cobra.NoArgs
	s.Command.Flags().StringVar(&s.Name, "name", "", "The name of the search attribute to delete.")
	s.ClientOptions.BuildFlags(s.Command.Flags())
	s.NamespaceOptions.BuildFlags(s.Command.Flags())
	s.ResourceModifyOptions.BuildFlags(s.Command.Flags())
	s.Command.Run = func(c *cobra.Command, args []string) {
