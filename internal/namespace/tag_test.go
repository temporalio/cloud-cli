...
func TestSetTags_Success(t *testing.T) {
	...
	mockCloud.EXPECT().
		UpdateNamespaceTags(ctx, mock.MatchedBy(func(req *cloudservice.UpdateNamespaceTagsRequest) bool {
			expected := &cloudservice.UpdateNamespaceTagsRequest{
				Namespace: "test-namespace",
				TagsToUpsert: map[string]string{
					"environment": "staging",
					"team":        "backend",
				},
	...
	result, err := client.SetTags(ctx, namespace.SetTagsParams{
		Namespace: "test-namespace",
		Tags: []namespace.Tag{
...
func TestSetTags_NoTags(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
	...
	require.Error(t, err)
	assert.Nil(t, result)
	assert.Contains(t, err.Error(), "at least one tag must be specified")
}

func TestSetTags_UpdateNamespaceTagsError(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
...
func TestSetTags_WithAsyncOperationID(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)

	expectedOp := &operation.AsyncOperation{
		Id: "custom-async-op-id",
	}
...
func TestDeleteTags_Success(t *testing.T) {
	...
	mockCloud.EXPECT().
		UpdateNamespaceTags(ctx, mock.MatchedBy(func(req *cloudservice.UpdateNamespaceTagsRequest) bool {
			expected := &cloudservice.UpdateNamespaceTagsRequest{
				Namespace:        "test-namespace",
				TagsToRemove:     []string{"environment", "team"},
				AsyncOperationId: "test-async-op",
			}
			return proto.Equal(expected, req)
		})).
...
func TestDeleteTags_SingleKey(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
...
func TestDeleteTags_NoKeys(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
	...
	require.Error(t, err)
	assert.Nil(t, result)
	assert.Contains(t, err.Error(), "at least one tag key must be specified")
}
...
func TestDeleteTags_MultipleKeys(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
	...
	mockCloud.EXPECT().
		UpdateNamespaceTags(ctx, mock.MatchedBy(func(req *cloudservice.UpdateNamespaceTagsRequest) bool {
			expected := &cloudservice.UpdateNamespaceTagsRequest{
				Namespace:    "test-namespace",
				TagsToRemove: []string{"environment", "team", "cost-center"},
			}
			return proto.Equal(expected, req)
		})).
		Return(&cloudservice.UpdateNamespaceTagsResponse{
	...
	result, err := client.DeleteTags(ctx, namespace.DeleteTagsParams{
		Namespace: "test-namespace",
		Keys:      []string{"environment", "team", "cost-center"},
	})
