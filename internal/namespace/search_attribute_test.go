...
func TestListSearchAttributes_Success(t *testing.T) {
	...
	ns := &namespacev1.Namespace{
		...
		Spec: &namespacev1.NamespaceSpec{
			SearchAttributes: map[string]namespacev1.NamespaceSpec_SearchAttributeType{
				"CustomKeywordField": namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_KEYWORD,
				"CustomTextField":    namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_TEXT,
				"CustomIntField":     namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_INT,
			},
		},
	}
	...
	// Sort results for consistent comparison (map iteration is non-deterministic)
	resultMap := make(map[string]namespacev1.NamespaceSpec_SearchAttributeType)
	for _, attr := range result {
		resultMap[attr.Name] = attr.Type
	}

	assert.Equal(t, namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_KEYWORD, resultMap["CustomKeywordField"])
	assert.Equal(t, namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_TEXT, resultMap["CustomTextField"])
	assert.Equal(t, namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_INT, resultMap["CustomIntField"])
}
...
func TestCreateSearchAttribute_DuplicateAttribute(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
...
func TestRenameSearchAttribute_Success(t *testing.T) {
	...
	existingNamespace := &namespacev1.Namespace{
		...
		Spec: &namespacev1.NamespaceSpec{
			SearchAttributes: map[string]namespacev1.NamespaceSpec_SearchAttributeType{
				...
				"Other":   namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_TEXT,
			},
		},
	}
	...
	mockCloud.EXPECT().
		...
		Return(&cloudservice.RenameCustomSearchAttributeResponse{
			AsyncOperation: expectedOp,
		}, nil)
...
func TestDeleteSearchAttribute_Success(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
	...
	existingNamespace := &namespacev1.Namespace{
		...
		Spec: &namespacev1.NamespaceSpec{
			SearchAttributes: map[string]namespacev1.NamespaceSpec_SearchAttributeType{
				"FieldToDelete": namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_KEYWORD,
				"FieldToKeep":   namespacev1.NamespaceSpec_SEARCH_ATTRIBUTE_TYPE_TEXT,
			},
		},
	}
	...
	result, err := client.DeleteSearchAttribute(ctx, namespace.DeleteSearchAttributeParams{
		Namespace:        "test-namespace",
		Name:             "FieldToDelete",
		AsyncOperationID: "test-async-op",
	})
...
func TestDeleteSearchAttribute_NonExistentAttribute(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
...
func TestDeleteSearchAttribute_NoSearchAttributesConfigured(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
	...
	require.Error(t, err)
	assert.Nil(t, result)
	assert.Contains(t, err.Error(), "no search attributes configured")
}

func TestDeleteSearchAttribute_GetNamespaceError(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
...
func TestDeleteSearchAttribute_UpdateNamespaceError(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
...
func TestDeleteSearchAttribute_CustomResourceVersion(t *testing.T) {
	ctx := context.Background()
	mockCloud := nsmock.NewMockCloudService(t)
